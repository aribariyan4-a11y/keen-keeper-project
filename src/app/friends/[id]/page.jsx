...
export default function FriendDetailsPage({ params }) {
    ...
    const handleInteraction = (type) => {
        ...
        existingTimeline.unshift(newTimeline);
                        ...
                        <div className="bg-gray-100 p-4 rounded-xl">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 p-5">
                                ...
                                <button
                                    ...
                                    className="btn bg-white rounded-xl py-6 border-none hover:bg-blue-100"
                                >
                                ...
                                <button
                                    ...
                                    className="btn bg-white rounded-xl py-6 border-none hover:bg-purple-100"
                                >
